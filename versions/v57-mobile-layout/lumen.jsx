...
function OnboardingApp({ seed, seedId, onBriefSent, onSeeProserv }) {
  ...
  if (!checked) return <div style={{height:VH_FULL,display:"flex",alignItems:"center",justifyContent:"center"}}>Loading…</div>;
...
export function LiveChat() {
  ...
  if (state.loading) return <div style={{height:VH_FULL,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter', Arial, sans-serif",color:"#64748b"}}>Loading…</div>;
  return (
    <div style={{height:VH_FULL,display:"flex",flexDirection:"column",overflow:"hidden"}}>
      <div style={{flex:1,minHeight:0}}>
