...
//
// SETUP (inert until one auth path below is configured). GOOGLE_DRIVE_FOLDER_ID
// sets the target folder in all paths.
...
// True if any auth path is configured, so an unconfigured deploy degrades (501).
